    ...
    <>
      ...
      >
        <div className="grid gap-4">
          <div className="flex items-center justify-between">
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-white/58">Global access</p>
            <Send className="h-8 w-8 text-[#77e0d5]" />
          </div>
      ...
      <section className="bg-[#f6f8f5] px-5 py-20 sm:px-8 lg:px-10">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_0.85fr]">
          <Reveal>
            <div className="overflow-hidden rounded-lg border border-[#102c35]/10 bg-white shadow-[0_28px_90px_rgba(16,44,53,0.12)]">
              <iframe
          ...
          <div className="grid gap-4">
            {locations.map((location, index) => (
              <Reveal key={location.title} delay={index * 70}>
                <article className="signal-surface rounded-lg border border-[#102c35]/10 bg-white p-5 shadow-[0_16px_55px_rgba(16,44,53,0.07)]">
        ...
        <div className="mx-auto mt-10 grid max-w-7xl gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          <Reveal>
            <div className="rounded-lg bg-[#102c35] p-6 text-white shadow-[0_28px_90px_rgba(16,44,53,0.16)]">
              ...
              <p className="microcopy mt-4 text-sm leading-7 text-white/75">
