...
export function Youtube(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M2.5 7.1c-.2.8-.3 1.9-.3 3.4 0 1.5.1 2.6.3 3.4.4 1.7 1.8 3.1 3.5 3.5 1.5.4 4.5.6 6 .6s4.5-.2 6-.6c1.7-.4 3.1-1.8 3.5-3.5.2-.8.3-1.9.3-3.4 0-1.5-.1-2.6-.3-3.4-.4-1.7-1.8-3.1-3.5-3.5-1.5-.4-4.5-.6-6-.6s-4.5.2-6 .6c-1.7.4-3.1 1.8-3.5 3.5z" />
